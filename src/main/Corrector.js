...
Corrector.prototype = {
     ...
     * @return {void}
     */
    fillVocabularyListFromIndex: function () {
     ...
     */
    checkWordValidity: function (inputWord) {
    ...
    /**
     * Get list of similar words suggestion given an initial
     * word and a defined distance limit.
     *
     * @param  {string}  inputWord     Input word
     * @param  {integer} distanceLimit Distance limit
     * @return {array}                 Suggestion list of similar words
     */
    getSuggestion: function (inputWord, distanceLimit) {
        ...
        for (var word in this.data.unigrams) {
            if (this.data.unigrams.hasOwnProperty(word)) {
                ...
                // if (distanceLimit) {
                //     distance = levenshtein.distanceOnThreshold(inputWord, word, distanceLimit);
                // } else {
                    distance = levenshtein.distance(inputWord, word);
                // }
